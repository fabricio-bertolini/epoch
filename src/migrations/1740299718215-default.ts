...
export class Default1740299718215 implements MigrationInterface {
    name = 'Default1740299718215'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "viajantes" DROP COLUMN "numeroPassaporte"`);
        await queryRunner.query(`ALTER TABLE "viajantes" ADD "numeroPassaporte" text NOT NULL`);
    }
